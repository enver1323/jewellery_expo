...
class SlideController extends AdminController
{
    ...
    public function index(): View
    {
        ...
        return $this->render('admin.slides.slideIndex', [
            'slides' => $slides,
        ]);
    }
    ...
    {
        return $this->render('admin.slides.slideCreate', [
            'slide' => $slide,
        ]);
    }
    ...
    {
        return $this->render('admin.slides.slideShow', [
            'slide' => $slide,
        ]);
    }
    ...
    {
        return $this->render('admin.slides.slideEdit', [
            'slide' => $slide
        ]);
    }
