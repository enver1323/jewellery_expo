...
/***/ "./resources/js/models/equipmentSelect.js":
/*!************************************************!*\
  !*** ./resources/js/models/equipmentSelect.js ***!
  \************************************************/
/*! exports provided: default */
...
/* harmony import */ var _apiSelect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./apiSelect */ "./resources/js/models/apiSelect.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/*#__PURE__*/
function () {
  function EquipmentSelect(parentId, link) {
    _classCallCheck(this, EquipmentSelect);

    this.setVars(parentId, link);
    this.initSelect();
  }

  _createClass(EquipmentSelect, [{
    key: "setVars",
    value: function setVars(parentId, link) {
      this.name = "equipment";
    ...
    value: function initSelect() {
      ...
      new _apiSelect__WEBPACK_IMPORTED_MODULE_1__["default"]("#".concat(this.name, "Select"), this.link);
    }
  }, {
    key: "handleEvent",
    ...
    value: function addEntries(button) {
      ...
      if (this.isEntryNotCreated(option)) this.addEntryField(option.value, option.innerHTML);
    }
  }, {
    key: "addEntryField",
    value: function addEntryField(optionId, optionName, quantity) {
      var div = document.createElement('div');
      _helpers_mainHelper__WEBPACK_IMPORTED_MODULE_0__["setAttributes"](div, {
        'class': 'md-form d-flex'
      });
      ...
      _helpers_mainHelper__WEBPACK_IMPORTED_MODULE_0__["setAttributes"](input, {
        'class': 'form-control',
        'type': 'number',
        'name': "".concat(this.name + "[" + optionId + "][quantity]"),
        'id': "".concat(this.name + optionId),
        'value': quantity,
        'required': ''
      });
      ...
      _helpers_mainHelper__WEBPACK_IMPORTED_MODULE_0__["setAttributes"](inputQuantity, {
        'hidden': '',
        'type': 'number',
        'name': "".concat(this.name + "[" + optionId + "][stall_equipment_id]"),
        'value': optionId,
        'required': ''
      });
      ...
      var label = document.createElement('label');
      _helpers_mainHelper__WEBPACK_IMPORTED_MODULE_0__["setAttributes"](label, {
        'for': "".concat(this.name + optionId)
      });
      label.innerHTML = "".concat(optionName, " quantity");
      ...
      _helpers_mainHelper__WEBPACK_IMPORTED_MODULE_0__["setAttributes"](deleteBtn, {
        ...
        'id': "".concat(this.name + optionId, "DeletingBtn"),
        'type': 'button'
      });
    ...
    value: function removeEntryField(entry) {
      var id = entry.id.replace(this.name, '');
...
/* harmony default export */ __webpack_exports__["default"] = (EquipmentSelect);
...
/***/ 3:
/*!******************************************************!*\
  !*** multi ./resources/js/models/equipmentSelect.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! D:\Projects\php\jewellery_expo\resources\js\models\equipmentSelect.js */"./resources/js/models/equipmentSelect.js");
