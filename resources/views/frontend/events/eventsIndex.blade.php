<!-- Section: Details -->
<section id="events" class="section my-5">

    <h3 class="text-center dark-grey-text font-weight-bold mb-5 pt-5">
        <strong>Event Schedule</strong>
    </h3>

    <!-- Section description -->
    <p class="text-center w-responsive mx-auto my-5 grey-text">Duis aute irure
            ...
            <div class="timeline-main">
                ...
                <ul class="stepper stepper-vertical timeline timeline-simple pl-0">
                    ...
                    <li>
                        ...
                        <!-- Section Description -->
                        <div class="step-content z-depth-1 ml-xl-1 p-4 hoverable">
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="step-content z-depth-1 ml-xl-0 p-4 hoverable">
                            ...
                            <p class="text-muted mt-3">
                                ...
                                <strong class="dark-grey-text font-weight-bold">Maria Wiliams - CEO of
                                    Intel</strong>
                            </p>
                    ...
                    <li>
                        ...
                        <div class="step-content z-depth-1 ml-xl-1 p-4 hoverable">
                            ...
                            <p class="text-muted mt-3">
                                ...
                                <strong class="dark-grey-text font-weight-bold">Kate Brown - UI/UX
                                    Designer</strong>
                            </p>
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="step-content z-depth-1 ml-xl-0 p-4 hoverable">
                            ...
                            <p class="text-muted mt-3">
                                ...
                                <strong class="dark-grey-text font-weight-bold">Anna Smith - Marketing
                                    specialist</strong>
                            </p>
                            ...
                            <div class="row pt-2">
                                ...
                                <div class="col-md-9 col-9">
                                    ...
                                    <p class="mb-0">Autem quibusdam et aut officiis debitis aut rerum
                    ...
                    <li>
                        ...
                        <div class="step-content z-depth-1 ml-xl-1 p-4 hoverable">
                            ...
                            <p class="text-muted mt-3">
                                ...
                                <strong class="dark-grey-text font-weight-bold">John Doe - CEO of
                                    Google</strong>
                            </p>
