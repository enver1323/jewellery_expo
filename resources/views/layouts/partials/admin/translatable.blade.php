...
<script type="text/javascript" src="{{mix('js/translatable.js')}}"></script>
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        let {{$name}}Entries = new Translatable("{{$name}}", "{{$name}}Container", @json($languages, JSON_UNESCAPED_UNICODE), "{{$input ?? 'input'}}");
