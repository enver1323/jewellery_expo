        ...
        function l(e) {
            if (e) {
                ...
                for (var o = 0; i > o; o++) if (g.State.calls[o]) {
                    var r = g.State.calls[o], s = r[0], d = r[2], p = r[3], f = !!p, m = null;
                    ...
                    for (var v = Math.min((t - p) / d.duration, 1), y = 0, w = s.length; w > y; y++) {
                        ...
                        if (a(S)) {
                            ...
                            for (var T in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(S, "visibility", d.visibility), k) if ("element" !== T) {
                                var A, I = k[T], P = h.isString(I.easing) ? g.Easings[I.easing] : I.easing;
                                if (1 === v) A = I.endValue; else {
                                    var E = I.endValue - I.startValue;
                                    if (A = I.startValue + E * P(v, d, E), !f && A === I.currentValue) continue
                                }
                                if (I.currentValue = A, "tween" === T) m = A; else {
                                    if (b.Hooks.registered[T]) {
                                        var O = b.Hooks.getRoot(T), M = a(S).rootPropertyValueCache[O];
                                        M && (I.rootPropertyValue = M)
                                    }
                                    var $ = b.setPropertyValue(S, T, I.currentValue + (0 === parseFloat(A) ? "" : I.unitType), I.rootPropertyValue, I.scrollData);
                                    b.Hooks.registered[T] && (a(S).rootPropertyValueCache[O] = b.Normalizations.registered[O] ? b.Normalizations.registered[O]("extract", null, $[1]) : $[1]), "transform" === $[0] && (C = !0)
                                }
                            }
            ...
            var b = g.CSS = {
                ...
                Hooks: {
                    templates: {
                        ...
                        for (i in b.Hooks.templates) for (var e in o = (n = b.Hooks.templates[i])[0].split(" ")) {
                            var r = i + o[e], s = e;
                ...
                getPropertyValue: function (e, i, o, r) {
                    ...
                    if (!/^[\d-]/.test(l)) if (a(e) && a(e).isSVG && b.Names.SVGAttribute(i)) if (/^(height|width)$/i.test(i)) try {
                        l = e.getBBox()[i]
                    } catch (e) {
                        l = 0
                    } else l = e.getAttribute(i); else l = s(e, b.Names.prefixCheck(i)[0]);
            ...
            var w = function () {
                ...
                function r() {
                    function e(e) {
                        ...
                        if ("scroll" === A) {
                            var w, k, T, P = /^x$/i.test(c.axis) ? "Left" : "Top", E = parseFloat(c.offset) || 0;
                            ...
                            for (var M in O) if ("element" !== M) {
                                var $ = O[M].startValue;
                                O[M].startValue = O[M].currentValue = O[M].endValue, O[M].endValue = $, h.isEmptyObject(x) || (O[M].easing = c.easing), g.debug && console.log("reverse tweensContainer (" + M + "): " + JSON.stringify(O[M]), r)
                            }
                            d = O
                        } else if ("start" === A) {
                            for (var _ in a(r).tweensContainer && !0 === a(r).isAnimating && (O = a(r).tweensContainer), u.each(y, function (e, t) {
                                ...
                                var R = p(y[_]), V = R[0], j = R[1], H = R[2];
                                _ = b.Names.camelCase(_);
                                var F = b.Hooks.getRoot(_), W = !1;
                                if (a(r).isSVG || "tween" === F || !1 !== b.Names.prefixCheck(F)[1] || b.Normalizations.registered[F] !== n) {
                                    (c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(_) && !H && 0 !== V && (H = 0), c._cacheValues && O && O[_] ? (H === n && (H = O[_].endValue + O[_].unitType), W = a(r).rootPropertyValueCache[F]) : b.Hooks.registered[_] ? H === n ? (W = b.getPropertyValue(r, F), H = b.getPropertyValue(r, _, W)) : W = b.Hooks.templates[F][1] : H === n && (H = b.getPropertyValue(r, _));
                                    var Y, N, z, X = !1;
                                    if (H = (Y = f(_, H))[0], z = Y[1], V = (Y = f(_, V))[0].replace(/^([+-\/*])=/, function (e, t) {
                                        return X = t, ""
                                    }), N = Y[1], H = parseFloat(H) || 0, V = parseFloat(V) || 0, "%" === N && (/^(fontSize|lineHeight)$/.test(_) ? (V /= 100, N = "em") : /^scale/.test(_) ? (V /= 100, N = "") : /(Red|Green|Blue)$/i.test(_) && (V = V / 100 * 255, N = "")), /[\/*]/.test(X)) N = z; else if (z !== N && 0 !== H) if (0 === V) N = z; else {
                                        o = o || m();
                        ...
                        d.element && (b.Values.addClass(r, "velocity-animating"), D.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, C === S - 1 ? (g.State.calls.push([D, v, c, null, I.resolver]), !1 === g.State.isTicking && (g.State.isTicking = !0, l())) : C++)
                    }

                    var o, r = this, c = u.extend({}, g.defaults, x), d = {};
                ...
                var d, p, f, v, y, x,
                    k = arguments[0] && (arguments[0].p || u.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || h.isString(arguments[0].properties));
                if (h.isWrapped(this) ? (d = !1, f = 0, v = this, p = this) : (d = !0, f = 1, v = k ? arguments[0].elements || arguments[0].e : arguments[0]), v = o(v)) {
                    ...
                    var A, I = {promise: null, resolver: null, rejecter: null};
                        ...
                        default:
                            if (!u.isPlainObject(y) || h.isEmptyObject(y)) {
                                if (h.isString(y) && g.Redirects[y]) {
                                    var E = (_ = u.extend({}, x)).duration, O = _.delay || 0;
                                    return !0 === _.backwards && (v = u.extend(!0, [], v).reverse()), u.each(v, function (e, t) {
                                        parseFloat(_.stagger) ? _.delay = O + parseFloat(_.stagger) * e : h.isFunction(_.stagger) && (_.delay = O + _.stagger.call(t, e, S)), _.drag && (_.duration = parseFloat(E) || (/^(callout|transition)/.test(y) ? 1e3 : m), _.duration = Math.max(_.duration * (_.backwards ? 1 - e / S : (e + 1) / S), .75 * _.duration, 200)), g.Redirects[y].call(t, t, _ || {}, e, S, v, I.promise ? I : n)
                                    }), e()
                                }
                                var M = "Velocity: First argument (" + y + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                return I.promise ? I.rejecter(new Error(M)) : console.log(M), e()
                            }
                            A = "start"
                    }
                    var $, _, L = {
                    ...
                    if (u.each(v, function (e, t) {
                        h.isNode(t) && r.call(t)
                    }), (_ = u.extend({}, g.defaults, x)).loop = parseInt(_.loop), $ = 2 * _.loop - 1, _.loop) for (var R = 0; $ > R; R++) {
                        var V = {delay: _.delay, progress: _.progress};
                        R === $ - 1 && (V.display = _.display, V.visibility = _.visibility, V.complete = _.complete), w(v, "reverse", V)
                    }
                    return e()
                }
            };
...
$(".smooth-scroll").on("click", "a", function () {
    ...
    e.fn.scrollTo = function (t) {
        ...
        this.each(function () {
            var i = e(this), n = e.extend({}, e.fn.dropdown.defaults, t), o = !1,
            ...
            function s(t) {
                ...
                var s = window.innerHeight, l = i.innerHeight(), c = i.offset().left,
                    u = i.offset().top - e(window).scrollTop(), d = n.alignment, p = 0, h = 0, f = 0;
                !0 === n.belowOrigin && (f = l);
                var m = 0, v = i.parent();
                if (!v.is("body") && v[0].scrollHeight > v[0].clientHeight && (m = v[0].scrollTop), c + a.innerWidth() > e(window).width() ? d = "right" : c - a.innerWidth() + i.innerWidth() < 0 && (d = "left"), u + a.innerHeight() > s) if (u + l - a.innerHeight() < 0) {
                    var g = s - u - f;
                    a.css("max-height", g)
                } else f || (f += l), f -= a.innerHeight();
                if ("left" === d) p = n.gutter, h = i.position().left + p; else if ("right" === d) {
...
dropdownSelectors.on({
    ...
    var t, i = function () {
        ...
        return _createClass(t, [{
            ...
            key: "debounce", value: function (e, t, i) {
                var n;
                return function () {
            ...
            key: "buildSingleOption", value: function (t, i) {
                var n = t.is(":disabled") ? "disabled" : "", o = "optgroup-option" === i ? "optgroup-option" : "",
                    a = t.data("icon"), r = t.data("fas") ? '<i class="fas fa-'.concat(t.data("fas"), '"></i> ') : "",
                    s = t.attr("class"), l = a ? '<img alt="" src="'.concat(a, '" class="').concat(s, '">') : "",
            ...
            key: "_onEachMaterialOptionClick", value: function (t, i, n) {
                n.stopPropagation();
                var o = e(i);
            ...
            key: "_onToggleAllClick", value: function () {
                var t = this, i = e(this.$toggleAll).find('input[type="checkbox"]').first(), n = !e(i).prop("checked");
            ...
            key: "_onMaterialSelectKeydown", value: function (t) {
                var i = e(t.target), n = t.which === this.keyCodes.tab, o = t.which === this.keyCodes.esc,
                    a = t.which === this.keyCodes.enter, r = t.which === this.keyCodes.arrowUp,
            ...
            key: "_handleLetterKey", value: function (t) {
                var i = this, n = "", o = String.fromCharCode(t.which).toLowerCase(),
            ...
            key: "_onSearchInputKeyup", value: function (t) {
                var i = e(t.target), n = i.closest("ul"), o = i.val();
            ...
            key: "_toggleSelectedValue", value: function (e) {
                var t = this.valuesSelected.indexOf(e), i = -1 !== t;
    ...
    function a(t, l, u, d) {
        if (!t) return a;
        var p = !1, h = {id: t.id || "P" + Math.abs(~~(Math.random() * new Date))},
            f = u ? e.extend(!0, {}, u.defaults, d) : d || {}, m = e.extend({}, a.klasses(), f.klass), v = e(t),
            g = function () {
                return this.start()
            }, y = g.prototype = {
                constructor: g, $node: v, start: function () {
                    ...
                    return h.open ? y : (v.addClass(m.active), s(t, "expanded", !0), setTimeout(function () {
                        ...
                        var i = t.keyCode, n = y.component.key[i], o = t.target;
        ...
        function w() {
            y.$holder.on({
                keydown: k, "focus.toOpen": x, blur: function () {
                ...
                var t = e(this), i = t.data(), n = t.hasClass(m.navDisabled) || t.hasClass(m.disabled), o = c();
                o = o && (o.type || o.href), (n || o && !e.contains(y.$root[0], o)) && y.$holder[0].focus(), !n && i.nav ? y.set("highlight", y.component.item.highlight, {nav: i.nav}) : !n && "pick" in i ? (y.set("select", i.pick), f.closeOnSelect && y.close(!0)) : i.clear ? (y.clear(), f.closeOnClear && y.close(!0)) : i.close && y.close(!0)
            })
        }
    ...
    function s(t, i, n) {
        if (e.isPlainObject(i)) for (var o in i) l(t, o, i[o]); else l(t, i, n)
    }
    ...
    o.prototype.set = function (e, t, i) {
        ...
        return t ? "string" == typeof t ? t = this.parse(e, t) : n.isInteger(t) && (t = this.now(e, t, {rel: t})) : t = "min" == e ? -1 / 0 : 1 / 0, t
        ...
        var a, r, s, l, c = this, u = i, d = o && o.interval ? o.interval : 1, p = -1 === c.item.enable, h = c.item.min,
            f = c.item.max, m = p && c.item.disable.filter(function (e) {
                if (t.isArray(e)) {
        ...
        if ((!o || !o.nav && !o.defaultValue) && (!p && c.disabled(i) || p && c.disabled(i) && (m || a || r) || !p && (i.pick <= h.pick || i.pick >= f.pick))) for (p && !m && (!r && d > 0 || !a && d < 0) && (d *= -1); c.disabled(i) && (Math.abs(d) > 1 && (i.month < u.month || i.month > u.month) && (i = u, d = d > 0 ? 1 : -1), i.pick <= h.pick ? (s = !0, d = 1, i = c.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : -1)])) : i.pick >= f.pick && (l = !0, d = -1, i = c.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : 1)])), !s || !l);) i = c.create([i.year, i.month, i.date + d]);
        return i
    ...
    var g = 0;
    var y = 135, b = 110, w = 80, x = 20, k = 2 * y, S = l ? 350 : 1,
    ...
    function T(e, t) {
        var i, o, r = n(C), l = r.find(".clockpicker-plate"), c = r.find(".picker__holder"),
            ...
            I = r.find(".clockpicker-am-pm-block"), P = "INPUT" === e.prop("tagName"), E = P ? e : e.find("input"),
            O = (E.prop("type"), n("label[for=" + E.attr("id") + "]")), M = this;
        if (this.id = (o = ++g + "", (i = "cp") ? i + o : o), this.element = e, this.holder = c, this.options = t, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = P, this.input = E, this.label = O, this.popover = r, this.plate = l, this.hoursView = h, this.minutesView = T, this.amPmBlock = I, this.spanHours = r.find(".clockpicker-span-hours"), this.spanMinutes = r.find(".clockpicker-span-minutes"), this.spanAmPm = r.find(".clockpicker-span-am-pm"), this.footer = r.find(".picker__footer"), this.amOrPm = "", t.twelvehour) {
        ...
        var _, L, D, R, V = n('<div class="clockpicker-tick"></div>');
        if (t.twelvehour) for (_ = 0; _ < 12; _ += t.hourstep) L = V.clone(), D = _ / 6 * Math.PI, R = b, L.css("font-size", "140%"), L.css({
            left: y + Math.sin(D) * R - x,
            top: y - Math.cos(D) * R - x
        }), L.html(0 === _ ? 12 : _), h.append(L), L.on(u, F); else for (_ = 0; _ < 24; _ += t.hourstep) {
            L = V.clone(), D = _ / 6 * Math.PI;
            var j = _ > 0 && _ < 13;
            R = j ? w : b, L.css({
                left: y + Math.sin(D) * R - x,
                top: y - Math.cos(D) * R - x
            }), j && L.css("font-size", "120%"), L.html(0 === _ ? "00" : _), h.append(L), L.on(u, F)
        }
        var H = Math.max(t.minutestep, 5);
        for (_ = 0; _ < 60; _ += H) for (_ = 0; _ < 60; _ += 5) L = V.clone(), D = _ / 30 * Math.PI, L.css({
            left: y + Math.sin(D) * b - x,
            top: y - Math.cos(D) * b - x
        }), L.css("font-size", "140%"), L.html(v(_)), T.append(L), L.on(u, F);

        function F(e, i) {
            var n = l.offset(), o = /^touch/.test(e.type), r = n.left + y, c = n.top + y,
                u = (o ? e.originalEvent.touches[0] : e).pageX - r, h = (o ? e.originalEvent.touches[0] : e).pageY - c,
                f = Math.sqrt(u * u + h * h), m = !1;
            if (!i || !(f < b - x || f > b + x)) {
                e.preventDefault();
                var v = setTimeout(function () {
                    M.popover.addClass("clockpicker-moving")
                }, 200);
                s && l.append(M.canvas), M.setHand(u, h, !i, !0), a.off(d).on(d, function (e) {
                    e.preventDefault();
                    ...
                    (i || m) && o === u && s === h && M.setHand(o, s), "hours" === M.currentView ? M.toggleView("minutes", S / 2) : t.autoclose && (M.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
                        M.done()
                    }, S / 2)), l.prepend(W), clearTimeout(v), M.popover.removeClass("clockpicker-moving"), a.off(d)
                })
            }
        }
        ...
        if (l.on(u, function (e) {
            ...
            var W = r.find(".clockpicker-canvas"), Y = f("svg");
            ...
            var q = f("circle");
            q.setAttribute("class", "clockpicker-canvas-fg"), q.setAttribute("r", 5), N.appendChild(X), N.appendChild(B), N.appendChild(q), N.appendChild(z), Y.appendChild(N), W.append(Y), this.hand = X, this.bg = B, this.fg = q, this.bearing = z, this.g = N, this.canvas = W
        }
        A(this.options.init)
    }
    ...
    T.DEFAULTS = {
        ...
        if (!this.isShown) {
            ...
            this.input.blur(), this.popover.addClass("picker--opened"), this.input.addClass("picker__input picker__input--active"), n(document.body).css("overflow", "hidden"), this.isAppended || (this.popover.insertAfter(this.input), this.options.twelvehour && (this.amOrPm = "PM", this.options.ampmclickable ? (this.spanAmPm.children("#click-pm").addClass("text-primary"), this.spanAmPm.children("#click-am").removeClass("text-primary")) : (this.amPmBlock.children(".am-button").removeClass("active"), this.amPmBlock.children(".pm-button").addClass("active"), this.spanAmPm.empty().append("PM"))), o.on("resize.clockpicker" + this.id, function () {
                ...
                27 === e.keyCode && t.hide()
            }, 300)), A(this.options.afterShow)
        }
    }, T.prototype.hide = function () {
        A(this.options.beforeHide), this.input.removeClass("picker__input picker__input--active"), this.popover.removeClass("picker--opened"), n(document.body).css("overflow", "visible"), this.isShown = !1, n(":input").each(function (e) {
        ...
        var a, r, l = Math.atan2(e, -t), c = "hours" === this.currentView, u = Math.sqrt(e * e + t * t),
            d = this.options, p = c && u < (b + w) / 2, f = p ? w : b;
        if (a = c ? d.hourstep / 6 * Math.PI : d.minutestep / 30 * Math.PI, d.twelvehour && (f = b), l < 0 && (l = 2 * Math.PI + l), l = (r = Math.round(l / a)) * a, c ? (r *= d.hourstep, d.twelvehour || !p != r > 0 || (r += 12), d.twelvehour && 0 === r && (r = 12), 24 === r && (r = 0)) : 60 === (r *= d.minutestep) && (r = 0), c ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : r % 5 == 0 ? this.fg.setAttribute("class", "clockpicker-canvas-fg") : this.fg.setAttribute("class", "clockpicker-canvas-fg active"), this[this.currentView] !== r && h && this.options.vibrate && (this.vibrateTimer || (navigator[h](10), this.vibrateTimer = setTimeout(n.proxy(function () {
            ...
            var m = Math.sin(l) * f, g = -Math.cos(l) * f;
        ...
        var e = this.input.prop("value"), t = this.hours, i = ":" + v(this.minutes);
    ...
    return function (e, t, i, n) {
        ...
        o.extend(r, n);
        var s, l, c, u, d, p, h, f, m, v, g, y, b, w, x, k, S, C, T, A, I, P, E, O, M, $, _, L, D, R, V, j, H, F, W, Y,
            N, z, X, B, q, U, Z, Q, K, G, J, ee, te, ie, ne, oe, ae, re, se, le = {x: 0, y: 0}, ce = {x: 0, y: 0},
            ue = {x: 0, y: 0}, de = {}, pe = 0, he = {}, fe = {x: 0, y: 0}, me = 0, ve = !0, ge = [], ye = {}, be = !1,
            we = function (e, t) {
                ...
                ee && (e && (v > a.currItem.fitRatio ? be || (Zt(a.currItem, !1, !0), be = !0) : be && (Zt(a.currItem), be = !1)), Ie(ee, ue.x, ue.y, v))
            }, Ee = function (e) {
                ...
                De && (o.unbind(document, "mousemove", Re), o.addClass(e, "pswp--has_mouse"), r.mouseUsed = !0, Ce("mouseUsed")), De = setTimeout(function () {
                    De = null
                }, 100)
            }, Ve = function (e, t) {
                ...
                return n === a.currItem.initialZoomLevel ? (i[e] = a.currItem.initialPosition[e], !0) : (i[e] = $e(e, n), i[e] > t.min[e] ? (i[e] = t.min[e], !0) : i[e] < t.max[e] && (i[e] = t.max[e], !0))
            }, We = function (e) {
                var t = "";
            ...
            }, ze = {}, Xe = 0, Be = function (e) {
                ze[e] && (ze[e].raf && $(ze[e].raf), Xe--, delete ze[e])
            }, qe = function (e) {
                ...
                var c = function () {
                    if (ze[e]) {
                        ...
                        a((i - t) * o(s / n) + t), ze[e].raf = M(c)
                    }
                };
                c()
            }, Qe = {
                shout: Ce, listen: Se, viewportSize: de, options: r, isMainScrollAnimating: function () {
                    return te
                    ...
                    if (!s && !l) {
                        var i;
                        a.framework = o, a.template = e, a.bg = o.getChildByClass(e, "pswp__bg"), _ = e.className, s = !0, V = o.detectFeatures(), M = V.raf, $ = V.caf, P = V.transform, D = V.oldIE, a.scrollWrap = o.getChildByClass(e, "pswp__scroll-wrap"), a.container = o.getChildByClass(a.scrollWrap, "pswp__container"), d = a.container.style, a.itemHolders = k = [{
                            ...
                            if (P) {
                                var t = V.perspective && !O;
                                return y = "translate" + (t ? "3d(" : "("), void (b = V.perspective ? ", 0px)" : ")")
                            }
                            P = "left", o.addClass(e, "pswp--ie"), Oe = function (e, t) {
                                t.left = e + "px"
                            }, Ee = function (e) {
                        ...
                        for (V.animationName && V.transform && !n || (r.showAnimationDuration = r.hideAnimationDuration = 0), i = 0; i < ge.length; i++) a["init" + ge[i]]();
                        t && (a.ui = new t(a, o)).init(), Ce("firstUpdate"), u = u || r.index || 0, (isNaN(u) || 0 > u || u >= Ft()) && (u = 0), a.currItem = Ht(u), (V.isOldIOSPhone || V.isOldAndroid) && (ve = !1), e.setAttribute("aria-hidden", "false"), r.modal && (ve ? e.style.position = "fixed" : (e.style.position = "absolute", e.style.top = o.getScrollY() + "px")), void 0 === R && (Ce("initialLayout"), R = L = o.getScrollY());
                        var c = "pswp--open ";
                        for (r.mainClass && (c += r.mainClass + " "), r.showHideOpacity && (c += "pswp--animate_opacity "), c += O ? "pswp--touch" : "pswp--notouch", c += V.animationName ? " pswp--css_animation" : "", c += V.svg ? " pswp--svg" : "", o.addClass(e, c), a.updateSize(), p = -1, me = null, i = 0; 3 > i; i++) Oe((i + p) * fe.x, k[i].el.style);
                        D || o.bind(a.scrollWrap, f, a), Se("initialZoomInEnd", function () {
                            a.setContent(k[0], u - 1), a.setContent(k[2], u + 1), k[0].el.style.display = k[2].el.style.display = "block", r.focus && e.focus(), o.bind(document, "keydown", a), V.transform && o.bind(a.scrollWrap, "click", a), r.mouseUsed || o.bind(document, "mousemove", Re), o.bind(window, "resize scroll", a), Ce("bindEvents")
                        }), a.setContent(k[1], u), a.updateCurrItem(), Ce("afterInit"), ve || (w = setInterval(function () {
                            Xe || z || K || v !== a.currItem.initialZoomLevel || a.updateSize()
                        }, 1e3)), o.addClass(e, "pswp--visible")
                    }
                }, close: function () {
                    s && (s = !1, l = !0, Ce("close"), o.unbind(window, "resize", a), o.unbind(window, "scroll", m.scroll), o.unbind(document, "keydown", a), o.unbind(document, "mousemove", Re), V.transform && o.unbind(a.scrollWrap, "click", a), z && o.unbind(window, h, a), Ce("unbindEvents"), Wt(a.currItem, null, !0, a.destroy))
                }, destroy: function () {
                    ...
                    var t = (e = xe(e)) - u;
                    me = t, u = e, a.currItem = Ht(u), pe -= t, Me(fe.x * pe), Ue(), te = !1, a.updateCurrItem()
                }, next: function () {
                    a.goTo(u + 1)
                }, prev: function () {
                    a.goTo(u - 1)
                    ...
                    if (0 !== me) {
                        ...
                        if (!(e && 2 > i)) {
                            ...
                            for (var n = 0; i > n; n++) me > 0 ? (t = k.shift(), k[2] = t, Oe((++p + 2) * fe.x, t.el.style), a.setContent(t, u - i + n + 1 + 1)) : (t = k.pop(), k.unshift(t), Oe(--p * fe.x, t.el.style), a.setContent(t, u + i - n - 1 - 1));
                            if (ee && 1 === Math.abs(me)) {
                                var o = Ht(S);
                                o.initialZoomLevel !== v && (Xt(o, de), Zt(o), Ee(o))
                            }
                    ...
                    if (de.x = a.scrollWrap.clientWidth, de.y = a.scrollWrap.clientHeight, Ne(), fe.x = de.x + Math.round(de.x * r.spacing), fe.y = de.y, Me(fe.x * pe), Ce("beforeResize"), void 0 !== p) {
                        for (var n, s, l, c = 0; 3 > c; c++) n = k[c], Oe((c + p) * fe.x, n.el.style), l = u + c - 1, r.loop && Ft() > 2 && (l = xe(l)), (s = Ht(l)) && (x || s.needsUpdate || !s.bounds) ? (a.cleanSlide(s), a.setContent(n, l), 1 === c && (a.currItem = s, a.updateCurrZoomItem(!0)), s.needsUpdate = !1) : -1 === n.index && l >= 0 && a.setContent(n, l), s && s.container && (Xt(s, de), Zt(s), Ee(s));
                        x = !1
                    }
            ...
            }, Ke = {}, Ge = {}, Je = {}, et = {}, tt = {}, it = [], nt = {}, ot = [], at = {}, rt = 0, st = {x: 0, y: 0},
            lt = 0, ct = {x: 0, y: 0}, ut = {x: 0, y: 0}, dt = {x: 0, y: 0}, pt = function (e, t) {
                ...
                return i = l > J.min[e] || l < J.max[e] ? r.panEndFriction : 1, l = ue[e] + t[e] * i, !r.allowPanToNext && v !== a.currItem.initialZoomLevel || (ee ? "h" !== ie || "x" !== e || B || (c ? (l > J.min[e] && (i = r.panEndFriction, J.min[e], n = J.min[e] - ce[e]), (0 >= n || 0 > d) && Ft() > 1 ? (s = u, 0 > d && u > nt.x && (s = nt.x)) : J.min.x !== J.max.x && (o = l)) : (l < J.max[e] && (i = r.panEndFriction, J.max[e], n = ce[e] - J.max[e]), (0 >= n || d > 0) && Ft() > 1 ? (s = u, d > 0 && u < nt.x && (s = nt.x)) : J.min.x !== J.max.x && (o = l))) : s = u, "x" !== e) ? void (te || Z || v > a.currItem.fitRatio && (ue[e] += t[e] * i)) : (void 0 !== s && (Me(s, !0), Z = s !== nt.x), J.min.x !== J.max.x && (void 0 !== o ? ue.x = o : Z || (ue.x += t.x * i)), void 0 !== s)
            }, At = function (e) {
                if (!("mousedown" === e.type && e.button > 0)) {
                    ...
                    if (!N || "mousedown" !== e.type) {
                        ...
                        var i = Ct(e), n = i.length;
                        Q = null, Ue(), z && 1 !== n || (z = ne = !0, o.bind(window, h, a), W = re = oe = Y = Z = q = X = B = !1, ie = null, Ce("firstTouchStart", i), _e(ce, ue), le.x = le.y = 0, _e(et, i[0]), _e(tt, et), nt.x = fe.x * pe, ot = [{
                            x: et.x,
                            y: et.y
                        }], H = j = Te(), Ve(v, !0), ht(), ft()), !K && n > 1 && !te && !Z && (g = v, B = !1, K = X = !0, le.y = le.x = 0, _e(ce, ue), _e(Ke, i[0]), _e(Ge, i[1]), bt(Ke, Ge, dt), ut.x = Math.abs(dt.x) - ue.x, ut.y = Math.abs(dt.y) - ue.y, G = pt(Ke, Ge))
                    }
                }
            }, It = function (e) {
                ...
                if (z) {
                    var n = Ct(e);
                    if (ie || q || K) Q = n; else if (ct.x !== fe.x * pe) ie = "h"; else {
                ...
                if (Q) {
                    ...
                    if (0 !== e) if (_e(Ke, Q[0]), Je.x = Ke.x - et.x, Je.y = Ke.y - et.y, K && e > 1) {
                        ...
                        0 > n && (n = 0), bt(Ke, Ge, st), le.x += st.x - dt.x, le.y += st.y - dt.y, _e(dt, st), ue.x = $e("x", i), ue.y = $e("y", i), W = i > v, v = i, Pe()
                    } else {
                        if (!ie) return;
                        ...
                        if ("v" === ie && r.closeOnVerticalDrag && "fit" === r.scaleMode && v === a.currItem.initialZoomLevel) {
                            le.y += Je.y, ue.y += Je.y;
                            var c = wt();
                            return Y = !0, Ce("onVerticalDrag", c), Ae(c), void Pe()
                        }
                        (function (e, t, i) {
                            if (e - H > 50) {
                ...
                var c = -1;
                if (0 === l && (z = !1, o.unbind(window, h, a), ht(), K ? c = 0 : -1 !== lt && (c = Te() - lt)), lt = 1 === l ? Te() : -1, n = -1 !== c && 150 > c ? "zoom" : "swipe", K && 2 > l && (K = !1, 1 === l && (n = "zoomPointerUp"), Ce("zoomGestureEnded")), Q = null, q || B || te || Y) if (Ue(), F || (F = Ot()), F.calculateSwipeSpeed("x"), Y) if (wt() < r.verticalDragRange) a.close(); else {
                    var u = ue.y, d = ae;
                    Ze("verticalDrag", 0, 1, 300, o.easing.cubic.out, function (e) {
                        ue.y = (a.currItem.initialPosition.y - u) * e + u, Ae((1 - d) * e + d), Pe()
                    }), Ce("onVerticalDrag", 1)
                } else {
                    if ((Z || te) && 0 === l) {
                        if ($t(n, F)) return;
                    ...
                    if (!te) return "swipe" !== n ? void Lt() : void (!Z && v > a.currItem.fitRatio && Mt(F))
                }
            }, Ot = function () {
                var e, t, i = {
                    lastFlickOffset: {},
                    ...
                    calculateSwipeSpeed: function (n) {
                        ot.length > 1 ? (e = Te() - H + 50, t = ot[ot.length - 2][n]) : (e = Te() - j, t = tt[n]), i.lastFlickOffset[n] = et[n] - t, i.lastFlickDist[n] = Math.abs(i.lastFlickOffset[n]), i.lastFlickDist[n] > 20 ? i.lastFlickSpeed[n] = i.lastFlickOffset[n] / e : i.lastFlickSpeed[n] = 0, Math.abs(i.lastFlickSpeed[n]) < .1 && (i.lastFlickSpeed[n] = 0), i.slowDownRatio[n] = .95, i.slowDownRatioReverse[n] = 1 - i.slowDownRatio[n], i.speedDecelerationRatio[n] = 1
                    },
                ...
                return i || p > ct.x == t.lastFlickSpeed.x > 0 ? (d = Math.abs(t.lastFlickSpeed.x) > 0 ? h / Math.abs(t.lastFlickSpeed.x) : 333, d = Math.min(d, 400), d = Math.max(d, 250)) : d = 333, rt === u && (i = !1), te = !0, Ce("mainScrollAnimStart"), Ze("mainScroll", ct.x, p, d, o.easing.cubic.out, Me, function () {
                ...
                t > v ? e = t : v > i && (e = i);
                var n, r = ae;
                return oe && !W && !re && t > v ? (a.close(), !0) : (oe && (n = function (e) {
                    Ae((1 - r) * e + r)
            ...
            publicMethods: {
                initGestures: function () {
                    var e = function (e, t, i, n, o) {
                        C = e + t, T = e + i, A = e + n, I = o ? e + o : ""
                    };
                    (E = V.pointerEvent) && V.touch && (V.touch = !1), E ? navigator.pointerEnabled ? e("pointer", "down", "move", "up", "cancel") : e("MSPointer", "Down", "Move", "Up", "Cancel") : V.touch ? (e("touch", "start", "move", "end", "cancel"), O = !0) : e("mouse", "down", "move", "up"), h = T + " " + A + " " + I, f = C, E && !O && (O = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1), a.likelyTouchDevice = O, m[C] = At, m[T] = It, m[A] = Et, I && (m[I] = m[A]), V.touch && (f += " mousedown", h += " mousemove mouseup", m.mousedown = m[C], m.mousemove = m[T], m.mouseup = m[A]), O || (r.allowPanToNext = !1)
                }
            }
        });
        var Dt, Rt, Vt, jt, Ht, Ft, Wt = function (t, i, n, s) {
            var l;
            Dt && clearTimeout(Dt), jt = !0, Vt = !0, t.initialLayout ? (l = t.initialLayout, t.initialLayout = null) : l = r.getThumbBoundsFn && r.getThumbBoundsFn(u);
            var d = n ? r.hideAnimationDuration : r.showAnimationDuration, p = function () {
                Be("initialZoom"), n ? (a.template.removeAttribute("style"), a.bg.removeAttribute("style")) : (Ae(1), i && (i.style.display = "block"), o.addClass(e, "pswp--animated-in"), Ce("initialZoom" + (n ? "OutEnd" : "InEnd"))), s && s(), jt = !1
            };
            if (!d || !l || void 0 === l.x) return Ce("initialZoom" + (n ? "Out" : "In")), v = t.initialZoomLevel, _e(ue, t.initialPosition), Pe(), e.style.opacity = n ? 0 : 1, Ae(1), void (d ? setTimeout(function () {
                p()
            }, d) : p());
            !function () {
                ...
                t.miniImg && (t.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (v = l.w / t.w, ue.x = l.x, ue.y = l.y - L, a[s ? "template" : "bg"].style.opacity = .001, Pe()), qe("initialZoom"), n && !i && o.removeClass(e, "pswp--animated-in"), s && (n ? o[(i ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function () {
                    ...
                    if (Ce("initialZoom" + (n ? "Out" : "In")), n) {
                        var a = l.w / t.w, r = {x: ue.x, y: ue.y}, c = v, u = ae, h = function (t) {
                            1 === t ? (v = a, ue.x = l.x, ue.y = l.y - R) : (v = (a - c) * t + c, ue.x = (l.x - r.x) * t + r.x, ue.y = (l.y - R - r.y) * t + r.y), Pe(), s ? e.style.opacity = 1 - t : Ae(u - t * u)
                        };
                        i ? Ze("initialZoom", 0, 1, d, o.easing.cubic.out, h, p) : (h(1), Dt = setTimeout(p, d + 20))
                    } else v = t.initialZoomLevel, _e(ue, t.initialPosition), Pe(), Ae(1), s ? e.style.opacity = 1 : Ae(1), Dt = setTimeout(p, d + 20)
                }, n ? 25 : 90)
            }()
        }, Yt = {}, Nt = [], zt = {
            index: 0,
        ...
        we("Controller", {
            publicMethods: {
                lazyLoadItem: function (e) {
                    ...
                    o.extend(r, zt, !0), a.items = Rt = i, Ht = a.getItemAt, Ft = r.getNumItemsFn, r.loop, Ft() < 3 && (r.loop = !1), Se("beforeChange", function (e) {
                        var t, i = r.preload, n = null === e || e >= 0, o = Math.min(i[0], Ft()),
                            s = Math.min(i[1], Ft());
                    ...
                    if (l) {
                        ...
                        if (!l.src && l.html && (l.html.tagName ? c.appendChild(l.html) : c.innerHTML = l.html), Ut(l), Xt(l, de), !l.src || l.loadError || l.loaded) l.src && !l.loadError && ((n = o.createEl("pswp__img", "img")).style.opacity = 1, n.src = l.src, Zt(l, n), Bt(0, l, c, n)); else {
                            if (l.loadComplete = function (i) {
                                if (s) {
                                    if (e && e.index === t) {
                                        if (Ut(i, !0)) return i.loadComplete = i.img = null, Xt(i, de), Ee(i), void (e.index === u && a.updateCurrZoomItem());
                                        i.imageAppended ? !jt && i.placeholder && (i.placeholder.style.display = "none", i.placeholder = null) : V.transform && (te || jt) ? Nt.push({
                                            item: i,
                                            baseDiv: c,
                                            img: i.img,
                                            index: t,
                            ...
                            l.loading || qt(l), a.allowProgressiveImg() && (!Vt && V.transform ? Nt.push({
                                item: l,
                                baseDiv: c,
                                img: l.img,
                                index: t,
                        ...
                        Vt || t !== u ? Ee(l) : (ee = c.style, Wt(l, n || l.img)), e.el.innerHTML = "", e.el.appendChild(c)
                    } else e.el.innerHTML = ""
        ...
        var Kt, Gt, Jt = {}, ei = function (e, t, i) {
        ...
        we("Tap", {
            ...
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    if (v <= a.currItem.fitRatio) return r.modal && (!r.closeOnScroll || Xe || z ? e.preventDefault() : P && Math.abs(e.deltaY) > 2 && (c = !0, a.close())), !0;
        ...
        var ti, ii, ni, oi, ai, ri, si, li, ci, ui, di, pi, hi = {history: !0, galleryUID: 1}, fi = function () {
            ...
            if (r.galleryPIDs) {
                var a = t.pid;
                for (t.pid = 0, i = 0; i < Rt.length; i++) if (Rt[i].pid === a) {
                    t.pid = i;
                    break
                }
            ...
            if (ni && clearTimeout(ni), Xe || z) ni = setTimeout(gi, 500); else {
    ...
    "use strict";
    return function (e, t) {
        var i, n, o, a, r, s, l, c, u, d, p, h, f, m, v, g, y, b, w = this, x = !1, k = !0, S = !0, C = {
            ...
            return e.shout("shareLinkClick", t, i), !(!i.href || !i.hasAttribute("download") && (window.open(i.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)), S || O(), 1))
        }, $ = function () {
            ...
            if (A()) {
                var r = v.barsSize;
                if (v.captionEl && "auto" === r.bottom) if (a || ((a = t.createEl("pswp__caption pswp__caption--fake")).appendChild(t.createEl("pswp__caption__center")), n.insertBefore(a, o), t.addClass(n, "pswp__ui--fit")), v.addCaptionHTMLFn(e, a, !0)) {
        ...
        w.init = function () {
            t.extend(e.options, C, !0), v = e.options, n = t.getChildByClass(e.scrollWrap, "pswp__ui"), d = e.listen, function () {
                var e;
                ...
                S || O(), y && clearInterval(y), t.unbind(document, "mouseout", R), t.unbind(document, "mousemove", D), t.unbind(n, "pswpTap click", T), t.unbind(e.scrollWrap, "pswpTap", w.onGlobalTap), t.unbind(e.scrollWrap, "mouseover", w.onMouseOver), i && (t.unbind(document, i.eventK, w.updateFullscreen), i.isFullscreen() && (v.hideAnimationDuration = 0, i.exit()), i = null)
            }), d("destroy", function () {
                ...
                t.bind(document, "mousemove", D), t.bind(document, "mouseout", R), y = setInterval(function () {
                    2 == ++L && w.setIdle(!0)
                }, v.timeToIdle / 2)
            }), v.fullscreenEl && !t.features.isOldAndroid && (i || (i = w.getFullscreenAPI()), i ? (t.bind(document, i.eventK, w.updateFullscreen), w.updateFullscreen(), t.addClass(e.template, "pswp--supports-fs")) : t.removeClass(e.template, "pswp--supports-fs")), v.preloaderEl && (V(!0), d("beforeChange", function () {
            ...
            k && e.currItem ? (w.updateIndexIndicator(), v.captionEl && (v.addCaptionHTMLFn(e.currItem, o), I(o, "caption--empty", !e.currItem.title)), x = !0) : x = !1, S || O(), P()
...
initPhotoSwipeFromDOM(".mdb-lightbox"), function (e) {
    ...
    6: [function (e, t, i) {
        ...
        var o = e("./class"), a = e("./dom"), r = i.toInt = function (e) {
    ...
    7: [function (e, t, i) {
        "use strict";
        var n = e("./plugin/destroy"), o = e("./plugin/initialize"), a = e("./plugin/update");
        t.exports = {initialize: o, update: a, destroy: n}
    ...
    9: [function (e, t, i) {
        "use strict";
        var n = e("../lib/helper"), o = e("../lib/dom"), a = e("./instances");
    ...
    10: [function (e, t, i) {
        "use strict";
        var n = e("../instances"), o = e("../update-geometry"), a = e("../update-scroll");
        t.exports = function (e) {
            !function (e, t) {
                function i(e) {
    ...
    11: [function (e, t, i) {
        "use strict";
        var n = e("../../lib/helper"), o = e("../../lib/dom"), a = e("../instances"), r = e("../update-geometry"),
            s = e("../update-scroll");
        t.exports = function (e) {
            var t = a.get(e);
            (function (e, t) {
                ...
                var a = null, l = null, c = function (t) {
    ...
    12: [function (e, t, i) {
            ...
            t.event.bind(t.ownerDocument, "keydown", function (n) {
                if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented)) {
                    ...
                    if (i || r) {
                        ...
                        l(e, "top", e.scrollTop - d), l(e, "left", e.scrollLeft + u), s(e), function (i, n) {
                            var o = e.scrollTop;
                            if (0 === i) {
        ...
        var o = e("../../lib/helper"), a = e("../../lib/dom"), r = e("../instances"), s = e("../update-geometry"),
            l = e("../update-scroll");
        t.exports = function (e) {
            n(e, r.get(e))
        }
    ...
    13: [function (e, t, i) {
        ...
        var o = e("../instances"), a = e("../update-geometry"), r = e("../update-scroll");
        t.exports = function (e) {
            n(e, o.get(e))
        }
    }, {"../instances": 18, "../update-geometry": 19, "../update-scroll": 20}],
    ...
    15: [function (e, t, i) {
        ...
        var o = e("../../lib/helper"), a = e("../instances"), r = e("../update-geometry"), s = e("../update-scroll");
        t.exports = function (e) {
            n(e, a.get(e))
        }
    ...
    16: [function (e, t, i) {
        "use strict";
        var n = e("../../lib/helper"), o = e("../instances"), a = e("../update-geometry"), r = e("../update-scroll");
        t.exports = function (e) {
            (n.env.supportsTouch || n.env.supportsIePointer) && function (e, t, i, n) {
                function s(i, n) {
                    var o = e.scrollTop, a = e.scrollLeft, r = Math.abs(i), s = Math.abs(n);
                    if (s > r) {
                ...
                function f(e) {
                    if (!x && t.settings.swipePropagation && h(e), !w && x && p(e)) {
                        var i = d(e), n = {pageX: i.pageX, pageY: i.pageY}, o = n.pageX - v.pageX,
                            a = n.pageY - v.pageY;
                        l(o, a), v = n;
                        var r = (new Date).getTime(), c = r - g;
    ...
    17: [function (e, t, i) {
        "use strict";
        var n = e("../lib/helper"), o = e("../lib/class"), a = e("./instances"), r = e("./update-geometry"), s = {
    ...
    18: [function (e, t, i) {
        ...
        function n(e) {
            ...
            var n = this;
            n.settings = a.clone(s), n.containerWidth = null, n.containerHeight = null, n.contentWidth = null, n.contentHeight = null, n.isRtl = "rtl" === l.css(e, "direction"), n.isNegativeScroll = function () {
                var t, i = e.scrollLeft;
                return e.scrollLeft = -1, t = e.scrollLeft < 0, e.scrollLeft = i, t
            }(), n.negativeScrollAdjustment = n.isNegativeScroll ? e.scrollWidth - e.clientWidth : 0, n.event = new c, n.ownerDocument = e.ownerDocument || document, n.scrollbarXRail = l.appendTo(l.e("div", "ps__scrollbar-x-rail"), e), n.scrollbarX = l.appendTo(l.e("div", "ps__scrollbar-x"), n.scrollbarXRail), n.scrollbarX.setAttribute("tabindex", 0), n.event.bind(n.scrollbarX, "focus", t), n.event.bind(n.scrollbarX, "blur", i), n.scrollbarXActive = null, n.scrollbarXWidth = null, n.scrollbarXLeft = null, n.scrollbarXBottom = a.toInt(l.css(n.scrollbarXRail, "bottom")), n.isScrollbarXUsingBottom = n.scrollbarXBottom == n.scrollbarXBottom, n.scrollbarXTop = n.isScrollbarXUsingBottom ? null : a.toInt(l.css(n.scrollbarXRail, "top")), n.railBorderXWidth = a.toInt(l.css(n.scrollbarXRail, "borderLeftWidth")) + a.toInt(l.css(n.scrollbarXRail, "borderRightWidth")), l.css(n.scrollbarXRail, "display", "block"), n.railXMarginWidth = a.toInt(l.css(n.scrollbarXRail, "marginLeft")) + a.toInt(l.css(n.scrollbarXRail, "marginRight")), l.css(n.scrollbarXRail, "display", ""), n.railXWidth = null, n.railXRatio = null, n.scrollbarYRail = l.appendTo(l.e("div", "ps__scrollbar-y-rail"), e), n.scrollbarY = l.appendTo(l.e("div", "ps__scrollbar-y"), n.scrollbarYRail), n.scrollbarY.setAttribute("tabindex", 0), n.event.bind(n.scrollbarY, "focus", t), n.event.bind(n.scrollbarY, "blur", i), n.scrollbarYActive = null, n.scrollbarYHeight = null, n.scrollbarYTop = null, n.scrollbarYRight = a.toInt(l.css(n.scrollbarYRail, "right")), n.isScrollbarYUsingRight = n.scrollbarYRight == n.scrollbarYRight, n.scrollbarYLeft = n.isScrollbarYUsingRight ? null : a.toInt(l.css(n.scrollbarYRail, "left")), n.scrollbarYOuterWidth = n.isRtl ? a.outerWidth(n.scrollbarY) : null, n.railBorderYWidth = a.toInt(l.css(n.scrollbarYRail, "borderTopWidth")) + a.toInt(l.css(n.scrollbarYRail, "borderBottomWidth")), l.css(n.scrollbarYRail, "display", "block"), n.railYMarginHeight = a.toInt(l.css(n.scrollbarYRail, "marginTop")) + a.toInt(l.css(n.scrollbarYRail, "marginBottom")), l.css(n.scrollbarYRail, "display", ""), n.railYHeight = null, n.railYRatio = null
        }
        ...
        var a = e("../lib/helper"), r = e("../lib/class"), s = e("./default-setting"), l = e("../lib/dom"),
            c = e("../lib/event-manager"), u = e("../lib/guid"), d = {};
        i.add = function (e) {
            var t = u();
            return function (e, t) {
    ...
    19: [function (e, t, i) {
        ...
        var o = e("../lib/helper"), a = e("../lib/class"), r = e("../lib/dom"), s = e("./instances"),
            l = e("./update-scroll");
        t.exports = function (e) {
            var t, i = s.get(e);
    ...
    20: [function (e, t, i) {
        "use strict";
        var n = e("./instances"), o = function (e) {
    ...
    (function (e) {
        ...
        var u = navigator.userAgent.indexOf("MSIE ") > -1 || navigator.userAgent.indexOf("Trident/") > -1 || navigator.userAgent.indexOf("Edge/") > -1,
            d = function () {
                ...
                return !1
            }(), p = void 0, h = void 0, f = void 0, m = !1, v = !1;
        ...
        function w() {
            if (y.length) {
                ...
                var e = m || !b || b.width !== p || b.height !== h, t = v || e || !b || b.y !== f;
                m = !1, v = !1, (e || t) && (y.forEach(function (i) {
                    e && i.onResize(), t && i.onScroll()
                }), b = {width: p, height: h, y: f}), (0, s.default)(w)
            }
        }
        ...
        var x = !!e.ResizeObserver && new e.ResizeObserver(function (e) {
            ...
            return o(e, [{
                ...
                key: "init", value: function () {
                    ...
                    }, e, t))), "opacity" !== this.options.type && "scale" !== this.options.type && "scale-opacity" !== this.options.type && 1 !== this.options.speed || (this.image.position = "absolute"), "fixed" === this.image.position) for (var o = 0, a = this.$item; null !== a && a !== document && 0 === o;) {
                ...
                key: "clipContainer", value: function () {
                    if ("fixed" === this.image.position) {
                        var e = this.image.$container.getBoundingClientRect(), t = e.width, i = e.height;
                ...
                key: "coverImage", value: function () {
                    var e = this.image.$container.getBoundingClientRect(), t = e.height, i = this.options.speed,
                        n = "scroll" === this.options.type || "scroll-opacity" === this.options.type, o = 0, a = t,
                        r = 0;
                ...
                key: "onScroll", value: function (e) {
                    var t = this.$item.getBoundingClientRect(), i = t.top, n = t.height, o = {}, a = t;
                    if (this.options.elementInViewport && (a = this.options.elementInViewport.getBoundingClientRect()), this.isElementInViewport = a.bottom >= 0 && a.right >= 0 && a.top <= h && a.left <= p, e || this.isElementInViewport) {
                        var r = Math.max(0, i), s = Math.max(0, n + i), l = Math.max(0, -i), c = Math.max(0, i + n - h),
                            u = Math.max(0, n - (i + n - h)), d = Math.max(0, -i + h - n),
                            f = 1 - 2 * (h - i) / (h + n), m = 1;
            ...
            for (var t = arguments[1], i = Array.prototype.slice.call(arguments, 2), n = e.length, o = 0, r = void 0; o < n; o++) if ("object" === (void 0 === t ? "undefined" : a(t)) || void 0 === t ? e[o].jarallax || (e[o].jarallax = new S(e[o], t)) : e[o].jarallax && (r = e[o].jarallax[t].apply(e[o].jarallax, i)), void 0 !== r) return r;
            return e
        };
    ...
    var n = i(4),
        o = n.requestAnimationFrame || n.webkitRequestAnimationFrame || n.mozRequestAnimationFrame || function (e) {
            var t = +new Date, i = Math.max(0, 16 - (t - a)), n = setTimeout(e, i);
            return a = t, n
        }, a = +new Date;
    ...
    var r = 0, s = 0, l = 0, c = 0, u = 0, d = new a, p = new a, h = function () {
        function e(t, i) {
            !function (e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, e);
        ...
        return o(e, [{
            ...
            key: "parseURL", value: function (e) {
                var t, i, n, o,
                    a = !(!(t = e.match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== t[1].length) && t[1],
                    r = function (e) {
                        var t = e.match(/https?:\/\/(?:www\.|player\.)?vimeo.com\/(?:channels\/(?:\w+\/)?|groups\/([^\/]*)\/videos\/|album\/(\d+)\/video\/|video\/|)(\d+)(?:$|\/|\?)/);
                        return !(!t || !t[3]) && t[3]
                    }(e), s = (i = e.split(/,(?=mp4\:|webm\:|ogv\:|ogg\:)/), n = {}, o = 0, i.forEach(function (e) {
                        var t = e.match(/^(mp4|webm|ogv|ogg)\:(.*)/);
                        t && t[1] && t[2] && (n["ogv" === t[1] ? "ogg" : t[1]] = t[2], o = 1)
                    }), !!o && n);
    ...
    Object.defineProperty(t, "__esModule", {value: !0}), t.default = function () {
        ...
        t.prototype.coverImage = function () {
            var e = a.apply(this), t = !!this.image.$item && this.image.$item.nodeName;
            if (e && this.video && t && ("IFRAME" === t || "VIDEO" === t)) {
                var i = e.image.height, n = i * this.image.width / this.image.height, o = (e.container.width - n) / 2,
                    r = e.image.marginTop;
            ...
            return _createClass(c, [{
                ...
                key: "inputKeyupData", value: function () {
                    ...
                    this.$input.on("keyup", function (i) {
                        var n = t.$input.val();
                        if (t.$autocompleteWrap.empty(), n.length) for (var o in t.options.data) if (-1 !== t.options.data[o].toLowerCase().indexOf(n.toLowerCase())) {
    ...
    e(".input-default-wrapper").on("change", ".input-default-js", function (t) {
        var i = e(t.target), n = i.next("label"), o = i[0].files, a = "";
